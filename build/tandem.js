...
},{"./build/client/file":3,"./build/client/network/adapter":4,"./build/client/tandem":6,"tandem-core":58}],2:[function(_dereq_,module,exports){
...
},{"eventemitter2":false,"lodash":false,"tandem-core/delta":57}],4:[function(_dereq_,module,exports){
(function() {
...
(function() {
  ...
  socketio = _dereq_('socket.io-client');
...
},{"./manager":9,"./socket":11,"./url":12,"debug":15,"socket.io-parser":46}],9:[function(_dereq_,module,exports){
...
},{"./on":10,"./socket":11,"./url":12,"component-bind":13,"component-emitter":14,"debug":15,"engine.io-client":16,"object-component":43,"socket.io-parser":46}],10:[function(_dereq_,module,exports){
...
},{"./on":10,"component-bind":13,"component-emitter":14,"debug":15,"has-binary":40,"indexof":42,"socket.io-parser":46,"to-array":50}],12:[function(_dereq_,module,exports){
(function (global){
...
},{"debug":15,"parseuri":44}],13:[function(_dereq_,module,exports){
/**
 * Slice reference.
 */
...
},{"./transport":19,"./transports":20,"component-emitter":14,"debug":15,"engine.io-parser":27,"indexof":42,"parsejson":36,"parseqs":37,"parseuri":38}],19:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":14,"engine.io-parser":27}],20:[function(_dereq_,module,exports){
(function (global){
/**
 * Module dependencies
 */
...
},{"./polling-jsonp":21,"./polling-xhr":22,"./websocket":24,"xmlhttprequest":25}],21:[function(_dereq_,module,exports){
(function (global){
...
},{"./polling":23,"component-inherit":26}],22:[function(_dereq_,module,exports){
(function (global){
/**
 * Module requirements.
 */
...
},{"./polling":23,"component-emitter":14,"component-inherit":26,"debug":15,"xmlhttprequest":25}],23:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":19,"component-inherit":26,"debug":15,"engine.io-parser":27,"parseqs":37,"xmlhttprequest":25}],24:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":19,"component-inherit":26,"debug":15,"engine.io-parser":27,"parseqs":37,"ws":39}],25:[function(_dereq_,module,exports){
...
},{"has-cors":34}],26:[function(_dereq_,module,exports){
...
},{"isarray":41}],41:[function(_dereq_,module,exports){
...
},{"./binary":45,"./is-buffer":47,"component-emitter":14,"debug":15,"isarray":48,"json3":49}],47:[function(_dereq_,module,exports){
(function (global){
...
},{"./insert":53,"./op":54,"./retain":55,"diff":59,"lodash":false}],52:[function(_dereq_,module,exports){
(function() {
...
},{"./delta":51,"./insert":53,"./retain":55,"lodash":false}],53:[function(_dereq_,module,exports){
(function() {
  var InsertOp, Op, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./op":54,"lodash":false}],54:[function(_dereq_,module,exports){
(function() {
  var Op, _;
...
},{"lodash":false}],55:[function(_dereq_,module,exports){
(function() {
  var Op, RetainOp, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./op":54,"lodash":false}],56:[function(_dereq_,module,exports){
(function() {
  module.exports = {
    Delta: _dereq_('./delta'),
...
},{"./delta":51,"./delta_generator":52,"./insert":53,"./op":54,"./retain":55}],57:[function(_dereq_,module,exports){
module.exports = _dereq_('./build/delta.js')

},{"./build/delta.js":51}],58:[function(_dereq_,module,exports){
module.exports = _dereq_('./build/tandem-core')

},{"./build/tandem-core":56}],59:[function(_dereq_,module,exports){
